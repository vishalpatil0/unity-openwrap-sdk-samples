...
{
    /// <summary>
    /// iOS reward client to hold information of rewards.
    /// </summary>
    internal class POBRewardClient : IPOBReward
    {
        ...
        {
            //rewards are equal if their amount & currencyTypes are same
            return amount == reward.GetAmount() && currencyType.Equals(reward.GetCurrencyType());
        }
        ...
        {
            return "Reward value: "+amount+" currency: "+currencyType;
        }
    }
}
#endif